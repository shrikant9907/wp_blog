...
<div class="index-page common-section-ui">
  <div class="container">
    <div class="row">
              ...
              <div class="card cui2 w-100 typography">
                <div class="card-body pri_30 pri_30 pli_30 pbi_30">
                  <h2 class='text-primary'>
                    <a class="text-primary tdn d-block" href="<?php the_permalink(); ?>" >
                      <?php the_title(); ?>
                    </a>
                  </h2>
                  <?php if(has_post_thumbnail()) { ?>
                    <a href="<?php the_permalink(); ?>" class="d-inline-block w-100">
                      <img class="card-img-top r_0 mb_15 border" src="<?php echo $image; ?>" alt="<?php the_title(); ?>" />
                    </a>
                  <?php } else { ?>
                    <a href="<?php the_permalink(); ?>" class="d-inline-block w-100">
                      <img class="card-img-top r_0 mb_15 border" src="<?php echo get_stylesheet_directory_uri(); ?>/images/placeholder_500x300.jpg" alt="">
                    </a>
                  <?php } ?>
                  <div class="text-dark px_5 py_5 mb_10 f14 d-flex justify-content-between">
                    ...
                    <span>
                      <i class="fa fa-clock mr_5 text-primary" aria-hidden="true"></i> 
